...
After attempting to wholesale copy my code from a previous Sinatra lesson over to my OpenShift application, I learned that the very first thing I read in the [Deploying section of chapter one][3] of The Ruby on Rails Tutorial was very good advice indeed:
